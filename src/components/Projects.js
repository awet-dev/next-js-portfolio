                                ...
                                <div className="flex h-full items-center justify-center">
                                    <div className="px-6 py-12 text-center text-white md:px-12">
                                        <h3 className="mb-6 text-2xl font-bold uppercase">
                                            Clothing management
                                            <u className="text-[hsl(210,12%,80%)] pl-2">platform</u>
                                        </h3>
                                        <p className="text-[hsl(210,12%,80%)]">
                                            Manages every thing from creating product, adding to the stock and
                                            send to warehouse, create package with collection of product. create
                                            shipment, send or schedule, and manage retuning shipments
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="w-full shrink-0 grow-0 basis-auto md:px-6 lg:w-7/12">
                    <div className="mb-12 flex">
                        <div className="shrink-0">
                            <div
                                className="rounded-md p-4 shadow-lg bg-[hsl(231,52.6%,20%)] dark:bg-[hsl(231,52.6%,30%)]">
