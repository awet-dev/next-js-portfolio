        ...
        <footer className="bg-neutral-200 text-center text-white dark:bg-neutral-600">
            <div className="pt-9">
                <div className="mb-9 flex justify-center">
                    <a href="https://www.linkedin.com/in/awet-tesfay-web-dev" className="mr-9 text-neutral-800 dark:text-neutral-200">
                        <svg
                    ...
                    <a href="https://github.com/awet-dev" className="text-neutral-800 dark:text-neutral-200">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-4 w-4"
                            fill="currentColor"
